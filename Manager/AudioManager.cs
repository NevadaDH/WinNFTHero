...
namespace Mao
{
    ...
    {
        private bool mEnableSound = true;
        ...
        public AudioSource PlaySound(string name, int instanceCount )
        {
        ...
        public void StopMusic(bool fadeout = false, float time = 0f)
        {
            ...
            if (fadeout)
            {
                ...
                StartCoroutine(FadeOutCoroutine(mMusic, time));
                mMusic = null;
            }
            else
            {
